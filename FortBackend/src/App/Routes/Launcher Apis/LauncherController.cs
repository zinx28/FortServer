    ...
    public class TempController : ControllerBase
    {
        ...
        public async Task<IActionResult> CallBack([FromQuery] string code)
        {
            try
            {
                ...
                {
                    string encodedMessage2 = Uri.EscapeDataString("Failed To Login </3");
                    return Redirect($"http://127.0.0.1:2158/callback?code=&message={encodedMessage2}");
                }
            ...
            string encodedMessage3 = Uri.EscapeDataString("Unknown Issue!");
            return Redirect($"http://127.0.0.1:2158/callback?code=&message={encodedMessage3}");
        }
