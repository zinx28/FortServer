...
using FortBackend.src.App.TCP_XMPP.Helpers.Send;
...
namespace FortBackend.src.App.TCP_XMPP.Root
{
    public class Iq
    {
        public async static void Init(TcpClient webSocket, XDocument xmlDoc, string clientId, DataSaved dataSaved)
        {
            try
            {
                string xmlMessage;
