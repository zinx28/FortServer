<template>
  <div class="sidebar">
    ...
    <nav>
      <ul>
        <li class="nav-item">
          <a @click="$emit('changeTab', 'home')" class="NavButton"
        ...
        <li class="nav-item">
          <a @click="$emit('changeTab', 'content')" class="NavButton"
        ...
        <li class="nav-item">
          <a @click="$emit('changeTab', 'admin')" class="NavButton"
    ...
    <div class="BottomDiV">
      ...
      <div class="BottomContainer">
        ...
        <div class="RightContainerFR" @click="toggleDropdown">
          <svg class="DownArrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
...
.sidebar {
  ...
  width: 250px;
  min-width: 250px;
  /* flex dir shrinks it lol on small screens */
  height: 100vh;
  display: flex;
  position: fixed;
...
.NavButton {
  ...
  color: white;
  /* makes it only show the color on hover bc ykykyk!! */
  text-align: left;
  font-size: 13px;
  gap: 8px;
  align-items: center;
